...
- (void)addSubViews
{
    ...
    self.stateLB = [UILabel labelWithText:@"交易成功" textColor:RGB(242, 0, 0) fontSize:13];
    [self.contentView addSubview:self.stateLB];
    [self.stateLB sizeToFit];
    [self.stateLB mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self.contentView).offset(-rateWidth(10));
